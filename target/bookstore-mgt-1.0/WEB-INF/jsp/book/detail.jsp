    ...
    <div class="row">
      <div class="col-sm-3 col-md-2 sidebar">
        <ul class="nav nav-sidebar">
          <li class="active">
            <a href="${ctx}/book/list">
              Book
              <span class="sr-only">(current)</span>
            </a>
          </li>
          <li >
            <a href="${ctx}/author/list">Author</a>
          </li>
        </ul>
      </div>
      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <h2 class="sub-header">Book Detail</h2>
        
  <form class="form-horizontal" action="edit" method="post">

    <div class="input-group">
      <span class="input-group-addon" id="name">名称:</span>
      <input  type="text" class="form-control" name="name" value="${bookdetail.name}">
    </div>
    </br>

    <div class="input-group">
      <span class="input-group-addon" id="description">简介:</span>
      <input  type="text" class="form-control" name="description" value="${bookdetail.description}">
    </div>
  </br>


		<div class="input-group">
			<span class="input-group-addon" id="status">作者:</span> 
			<select class="form-control" name="authorId" id="authorId">
				<c:forEach var="authorlist" items="${authorlist}">
					<option <c:if test="${bookdetail.authorId==authorlist.id}">selected</c:if> value="${authorlist.id}">${authorlist.name}</option>
				</c:forEach>
			</select>
		</div>
	</br>
    ...
    <div class="input-group">
      ...
      <div class="switch">
        <c:if test="${bookdetail.isDisplay == 1}">
...
<!-- 	</br> -->
    ...
    <a type="button" class="btn btn-default" href="${ctx}/book/list">返回</a>
  </form>
